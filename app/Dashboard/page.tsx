        ...
        >
          ...
          {user && (
            <div className="flex flex-col items-center mb-8 mt-8 lg:mt-0">
              <img
                src={user.picture} // Fallback image
                alt="User Profile"
              ...
              <button
                ...
                disabled={logoutLoading} // Disable button when logging out
            ...
            <ul className="space-y-2">
              <li>
                <button
                  onClick={() => {
                    setFilterType("today");
                    setIsSidebarOpen(false); // Close sidebar on filter click
                  }}
          ...
          <div className="bg-gray-800 rounded-lg shadow-xl p-4 md:p-6 flex-1">
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4">
              ...
              <input
                ...
                className="w-full sm:w-auto px-4 py-2 rounded-lg bg-gray-700 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 text-base"
            ...
            {currentFilteredTodos.length === 0 ? (
              ...
              <ul className="space-y-4">
                {currentFilteredTodos.map((todo) => (
                  <li
                    key={todo.id}
                    className={`p-4 rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center transition-all duration-200 ${
                      todo.completed
                  ...
                  >
                    {editingTodoId === todo.id ? (
                      ...
                      <>
                        <div className="flex items-start flex-1 mb-3 sm:mb-0 w-full sm:w-auto">
                          <input
                            type="checkbox"
                            checked={todo.completed}
                            onChange={() => handleToggleComplete(todo.id)}
                            className="form-checkbox h-5 w-5 text-green-500 rounded border-gray-500 focus:ring-green-500 transition-colors duration-200 cursor-pointer flex-shrink-0 mt-1"
                          />
                        ...
                        <div className="flex gap-2 self-end sm:self-center mt-3 sm:mt-0">
                          <button
                            ...
                            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm font-medium flex items-center gap-1"
                          >
                            <EditIcon /> Edit
                          </button>
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 flex items-center gap-1 ${
                              todo.completed
                                ? "bg-yellow-600 hover:bg-yellow-700 text-white" // Undo style
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 text-sm font-medium flex items-center gap-1"
                          >
                            <TrashIcon /> Delete
                          </button>
                        </div>
